...
<div class="logintop">
    ...
    <ul>
        <li><a href="../foreground/index.html">回首页</a></li>
        <li><a href="#">帮助</a></li>
        <li><a href="#">关于</a></li>
    </ul>
</div>
...
<div class="loginbody">
    ...
    <div class="loginbox">
        ...
        <ul>
            <li><input name="" type="text" class="loginuser" value="管理员账号" onclick="JavaScript:this.value=''"/></li>
...
<div class="loginbm">版权所有  2018  <a href="http://www.bdarno.com">bdarno.com</a>  仅供学习交流，勿用于任何商业用途</div>
