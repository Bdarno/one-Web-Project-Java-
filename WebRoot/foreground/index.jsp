...
<%@ include file="mods/head.jsp" %>
<%@ include file="mods/header.jsp" %>
<%@ include file="mods/leftBanner.jsp" %>
...
<%@ include file="mods/newsletter.jsp" %>
<%@ include file="mods/footer.jsp" %>
<%@ include file="mods/bootstrap.jsp" %>
<%@ include file="mods/endFooter.jsp" %> 